...
--17
INSERT INTO PRACOWNICY (ID_PRAC, NAZWISKO, ETAT, PLACA_POD) VALUES (PRAC_SEQ.nextval, 'TRĄBCZYNSKI', 'STAZYSTA', 1000);

--18
UPDATE PRACOWNICY SET PLACA_DOD = PRAC_SQL.CURRVAL WHERE NAZWISKO = 'TRĄBCZYNSKI';

--19
DELETE FROM PRACOWNICY WHERE NAZWISKO = 'TRĄBCZYNSKI';

--20
CREATE SEQUENCE MALA_SEQ  START WITH 9 INCREMENT BY 1 MAXVALUE 10;
--ORA-08004: sequence MALA_SEQ.NEXTVAL exceeds MAXVALUE and cannot be instantiated

--21
DROP SEQUENCE MALA_SEQ;
--Sequence MALA_SEQ dropped.
